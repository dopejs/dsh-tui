export type OverlayKind = 'activity' | 'attachments' | 'changes' | 'command-palette' | 'completion' | 'jobs' | 'mcp' | 'permissions' | 'plugins' | 'projections' | 'recovery' | 'session-center' | 'skills' | 'subagents'
